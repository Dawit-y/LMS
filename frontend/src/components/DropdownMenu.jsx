...
const dropdowns = [
  ...
  { path: "create", name: "Create Courses" },
];
  ...
  return (
    <div className="relative font-[sans-serif] w-max mx-auto">
      <button
        ...
        className="px-4 py-2 flex items-center rounded-full text-[#333] text-sm border border-gray-300 outline-none bg-gray-200  hover:bg-gray-100"
      >
        <img
      ...
      <ul
        ...
        } shadow-lg bg-white py-2 z-[1000] min-w-full w-max rounded-lg max-h-96 overflow-auto transition-all ease-in-out`}
      >
        {dropdowns.map((dropdown, index) => (
          ...
          >
            ...
            <Link to={dropdown.path}> {dropdown.name}</Link>
          </li>
        ))}
